    ...
    <div class="content-wrapper">
        <main class="container">
            ...
            <div class="d-flex justify-content-between align-items-center mt-4">
                <h3>Fotos do Produto: <?php echo htmlspecialchars($dadosProduto->nome_produto ?? 'N/A'); ?></h3>
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <img src="images/<?php echo htmlspecialchars($f->nome_arquivo); ?>" class="card-img-top"
                                    ...
                                    onerror="this.src='https://placehold.co/400x300/de9ca4/fff?text=Sem+Foto'">
                                <div class="card-body">
            ...
            <div class="mt-4 mb-5">
                <a href="apaProdutos.php" class="btn btn-info-custom">
